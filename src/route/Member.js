                    ...
                    <div className="profile">
                        <div className="profile-box">
                            ...
                            <div className="profile-content">
                                ...
                                <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'" class="btn btn-primary btn" href="/research/" role="button">Learn More</a>
